...
// const Achievement = () => {
//   return (
//     <div className='flex gap-36 bg-[#F5F7FA] items-center pl-44 -mt-10'>
//       <div className='mt-20'>
//         <h1 className='text-gray-700 text-5xl'>Helping a local</h1>
//         <h1 className='text-primary text-5xl'>business reinvent itself</h1>
//         <p>We reached here with our hardwork and dedication</p>
//       </div>
//       <div>
//         <ul className='flex gap-20'>
//           <li className='flex mt-11'>
//             <Image
...
//     <ul className='p-1'>
//             <h1 className='text-gray-700 font-semibold text-2xl'>2,245,341</h1>     
...
//             height={48}/>
//     <ul className='p-1'>
//             <h1 className='text-gray-700 font-semibold text-2xl'>46,328</h1>
...
//             height={48}/>
//     <ul className='p-1'>
//             <h1 className='text-gray-700 font-semibold text-2xl'>828,867</h1>
...
//             height={48}/>
//     <ul className='p-1'>
//             <h1 className='text-gray-700 font-semibold text-2xl'> 1,926,436</h1>
