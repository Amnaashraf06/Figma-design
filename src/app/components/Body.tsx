...
// const Body = () => {
//   return (
//     <div className='flex gap-15 p-20 ml-28'>
//       <div className='p-4'>
//         <Image
...
//       </div>
//       <div>
//         <h1 className='text-5xl pr-32 mt-14 p-2'>The unseen of spending three years at Pixelgrade</h1>
//         <p className='pr-32 text-xl p-2 pb-10'> Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias iure sint animi explicabo doloribus libero dolor ullam atque, corporis,
//             officia culpa ab odit minus laborum consequuntur qui pariatur provident quia!</p>
//         <button className='bg-primary text-white p-4 pr-8 pl-8 rounded'>Learn More</button>    
//       </div>
