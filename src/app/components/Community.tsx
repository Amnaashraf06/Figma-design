...
//       <div>
//         <h1 className='text-4xl text-gray-700 pt-6'>Manage your entire community</h1>
//         <h1 className='text-4xl text-gray-700'>in a single system</h1>
//         <p className='text-gray-400 p-1'>Who is Nextcent suitable for?</p>
//       </div>
//       <div>
//         <ul className='flex text-center gap-32 p-10'>
//             <li>
...
//                 width={65}/>
//                 </div>
//                 <h1 className='text-5xl'>Membership Organisations</h1>
//                 <p className='p-2 text-gray-400'>Our membership management software
//                      provides full automation of memberships renewals and payments</p>
//             </li>
...
//                 width={65}/>
//                 </div>
//                 <h1 className='text-5xl'>National Associations</h1>
//                 <p className='p-2 text-gray-400'>Our membership management software
//                 provides full automation of memberships renewals and payments</p>
//             </li>
...
//                 width={65}/>
//                 </div>
//                 <h1 className='text-5xl'>Clubs And Groups</h1>
//                 <p className='p-2 text-gray-400'>Our membership management software
//                 provides full automation of memberships renewals and payments</p>
//             </li>
