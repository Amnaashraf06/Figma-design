...
// const Hero = () => {
//   return (
//     <div className='flex mt-20 bg-[#F5F7FA]'>
//       <div className='ml-28 mt-20'>
//         <h1 className='text-6xl font-semibold text-gray-600'>Lessons and insights</h1>
//         <h2 className='text-6xl font-semibold text-primary'>from 8 years</h2>
//         <p className='text-gray-400 pt-4 pb-4'>where to grow your business as a photographer:site or social media?</p>
//         <button className='text-white bg-primary pl-2 pr-2 pt-2 pb-2'>Register</button>
//       </div>
//       <div className='flex'>
//         <Image
