...
//     <div>
//         <div>
//       <h1 className='text-gray-600 font-semibold text-center text-2xl p-2'>Caring is the new marketing</h1>
//       <p className='text-gray-400 text-center pr-[380px] pl-[360px]'>The Nexcent blog is the best place to read about the latest membership insights, 
