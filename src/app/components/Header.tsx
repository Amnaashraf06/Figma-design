...
// const Header = () => { 
//   return (
//     <div className='flex justify-between ml-32 mt-8'>
...
//       <div>
//         <ul className='flex gap-11 mr-32'>
//         <li className='mt-1'>Login</li>
//         <li>
//           <button className='bg-primary text-white rounded pl-2 pr-2 pb-1 pt-1'>Sign up</button>
//         </li>
//         </ul>
//       </div>
//     </div>
