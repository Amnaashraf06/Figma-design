...
// const Calendar = () => {
//   return (
//     <div className='flex gap-20 p-20 mr-10'>
...
//       </div>
//       <div>
//         <h1 className='text-gray-700 text-4xl pr-2 mt-14 p-4'>How to design your site footer like we did</h1>
//         <p className='text-gray-400 pr-2 text-xl p-4 pb-10'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nisi quod eos rerum nostrum nesciunt vero quidem suscipit illum animi iure
...
//         </p>
//         <button className='bg-primary text-white p-5 pr-8 pl-8 rounded'>Learn More</button>    
//       </div>
