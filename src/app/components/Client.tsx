...
//         <div>
//             <h1 className='text-center font-semibold text-gray-700 text-2xl'>Our Clients</h1>
//             <p className='text-center text-gray-400 p-2'>We have been working with some Fortune 500+ clients</p>
//         </div>

//         <div>
         
//             <ul className='flex gap-28 ml-[150px] p-3'>
//                 <li> 
